...
Search results can flood context. Use `mcp__context-mode__ctx_execute(language: "javascript", code: "...")` to run searches in sandbox. Only your printed summary enters context.
